    ...
    <div class="row row-cols-1">
        ...
        <div class="col my-1">
            <div class="card card-body bg-light m-auto">
              <form class="row row-cols-1 needs-validation" novalidate action="<?php echo RUTA_URL;?>/paginas/addUsuario" method="POST">
                <div class="col my-2">
                  <label for="nombre-usuario" class="form-label">Nombre:</label>
                  <input type="text" class="form-control" name="nombre-usuario" id="nombre-usuario" required>
                ...
                <div class="col my-2">
                  ...
                  <input type="tel" class="form-control" name="telefono-usuario" id="telefono-usuario" required>
                  <span class="text-muted" id="ayuda-telefono"></span>
                </div>
                <div class="col my-2">
                  <button class="btn btn-success form-control" type="submit">REGISTRAR</button>
                </div>
              </form>
            </div>
        </div>
