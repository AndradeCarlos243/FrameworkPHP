    ...
    <div class="row row-cols-1">
        ...
        <div class="col my-1">
            <div class="card card-body bg-light m-auto">
              <form class="row row-cols-1 needs-validation" novalidate action="<?php echo RUTA_URL;?>/paginas/deleteUsuario/<?php echo $data['idUsuario'];?>" method="POST">
                <div class="col my-2">
                ...
                <div class="col my-2">
                  <button class="btn btn-danger form-control" type="submit">ELIMINAR</button>
                </div>
              </form>
            </div>
        </div>
